...
<div class="space-y-4">
  <div class="flex items-center justify-between gap-3">
    ...
    <div class="relative h-10 w-10 overflow-hidden rounded-full border border-slate-200 bg-white shadow-sm ring-1 ring-black/5 hover:bg-slate-50 transition-colors">
